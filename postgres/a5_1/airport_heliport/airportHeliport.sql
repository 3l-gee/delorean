...
COALESCE(jsonb_agg(airport_heliport.city_view.name), '[]'::jsonb) AS servedCity,
COALESCE(jsonb_agg(airport_heliport.city_view.annotations), '[]'::jsonb) AS servedCity_annotation,
