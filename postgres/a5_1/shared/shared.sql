...
COALESCE(shared.timesheet.timereference_value, '(' || shared.timesheet.timereference_nilreason || ')') AS timereference,
COALESCE(shared.timesheet.startdate_value, '(' || shared.timesheet.startdate_nilreason || ')') AS startdate,
COALESCE(shared.timesheet.enddate_value, '(' || shared.timesheet.enddate_nilreason || ')') AS enddate,
COALESCE(shared.timesheet.day_value, '(' || shared.timesheet.day_nilreason || ')') AS day,
COALESCE(shared.timesheet.daytil_value, '(' || shared.timesheet.daytil_nilreason || ')') AS daytil,
COALESCE(shared.timesheet.starttime_value, '(' || shared.timesheet.starttime_nilreason || ')') AS starttime,
COALESCE(shared.timesheet.startevent_value, '(' || shared.timesheet.startevent_nilreason || ')') AS startevent,
COALESCE(shared.timesheet.starteventinterpretation_value, '(' || shared.timesheet.starteventinterpretation_nilreason || ')') AS starteventinterpretation,
COALESCE(shared.timesheet.starttimerelativeevent_value || ' ' || shared.timesheet.starttimerelativeevent_uom, '(' || shared.timesheet.starttimerelativeevent_nilreason || ')') AS starttimerelativeevent,
COALESCE(shared.timesheet.endtime_value, '(' || shared.timesheet.endtime_nilreason || ')') AS endtime,
COALESCE(shared.timesheet.endevent_value, '(' || shared.timesheet.endevent_nilreason || ')') AS endevent,
COALESCE(shared.timesheet.endeventinterpretation_value, '(' || shared.timesheet.endeventinterpretation_nilreason || ')') AS endeventinterpretation,
COALESCE(shared.timesheet.endtimerelativeevent_value || ' ' || shared.timesheet.endtimerelativeevent_uom, '(' || shared.timesheet.endtimerelativeevent_nilreason || ')') AS endtimerelativeevent,
COALESCE(shared.timesheet.daylightsavingadjust_value, '(' || shared.timesheet.daylightsavingadjust_nilreason || ')') AS daylightsavingadjust,
COALESCE(shared.timesheet.excluded_value, '(' || shared.timesheet.excluded_nilreason || ')') AS excluded,
