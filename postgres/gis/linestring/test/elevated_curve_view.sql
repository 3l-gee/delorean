...
merged_segments AS (
    ...
    INNER JOIN 
        public.elevated_curve_segment ON public.elevated_curve.id = public.elevated_curve_segment.elevatedcurvepropertytype_id
    INNER JOIN 
        segment_union ON public.elevated_curve_segment.segments_id = segment_union.id
