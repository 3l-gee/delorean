...
@Entity
@Table(name = "authorityfornavaidequipment", schema = "navaids_points")
    ...
    extends AbstractAIXMObjectType
{
    ...
    @JoinTable(name = "authorityforauthorityfornavaidequipment_annotation", joinColumns = {
        @JoinColumn(name = "authorityforauthorityfornavaidequipment_id")
    }, inverseJoinColumns = {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractauthorityfornavaidequipmentextension_id", referencedColumnName = "id")
