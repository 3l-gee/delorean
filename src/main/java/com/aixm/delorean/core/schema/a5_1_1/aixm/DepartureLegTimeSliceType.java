...
@Entity
@Table(name = "departure_leg_slice", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinColumn(name = "arc_centre_id", referencedColumnName = "id")
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstract_departure_leg_extension_id", referencedColumnName = "id")
        protected AbstractExtensionType abstractDepartureLegExtension;
        @XmlElement(name = "AbstractSegmentLegExtension")
        @OneToOne(cascade = {
            CascadeType.ALL
        }, fetch = FetchType.EAGER)
        @JoinColumn(name = "abstract_segment_leg_extension_id", referencedColumnName = "id")
