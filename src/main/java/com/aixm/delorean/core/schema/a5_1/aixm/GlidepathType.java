...
@Entity
@Table(name = "glidepathtype", schema = "navaids")
    ...
    extends AbstractNavaidEquipmentType
{
    ...
    @JoinTable(name = "glidepathtype_timeslice", joinColumns = {
        @JoinColumn(name = "glidepathtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "glidepathtimeslicepropertytype_id")
    })
