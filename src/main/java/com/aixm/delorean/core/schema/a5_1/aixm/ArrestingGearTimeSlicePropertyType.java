...
public class ArrestingGearTimeSlicePropertyType {
    ...
    @JoinColumn(name = "arrestinggeartimeslice_id", referencedColumnName = "id")
    protected ArrestingGearTimeSliceType arrestingGearTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "arrestinggear_tsp_seq")
    @SequenceGenerator(name = "arrestinggear_tsp_seq", sequenceName = "arrestinggear_tsp_seq", allocationSize = 1)
