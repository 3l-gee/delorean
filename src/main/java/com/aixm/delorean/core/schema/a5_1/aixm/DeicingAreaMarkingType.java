...
@Entity
@Table(name = "deicingareamarkingtype", schema = "markings")
    ...
    extends AbstractMarkingType
{
    ...
    @JoinTable(name = "deicingareamarkingtype_timeslice", joinColumns = {
        @JoinColumn(name = "deicingareamarkingtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "deicingareamarkingtimeslicepropertytype_id")
    })
