...
@XmlType(name = "TouchDownLiftOffPropertyType", propOrder = {
...
public class TouchDownLiftOffPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "touchdownliftoff_pt_seq")
    @SequenceGenerator(name = "touchdownliftoff_pt_seq", sequenceName = "touchdownliftoff_pt_seq", allocationSize = 1)
