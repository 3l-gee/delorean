...
@XmlType(name = "AirportHotSpotPropertyType", propOrder = {
...
public class AirportHotSpotPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airporthotspot_pt_seq")
    @SequenceGenerator(name = "airporthotspot_pt_seq", sequenceName = "airporthotspot_pt_seq", allocationSize = 1)
