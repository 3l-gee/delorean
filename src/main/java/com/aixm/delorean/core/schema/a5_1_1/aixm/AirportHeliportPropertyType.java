...
@XmlType(name = "AirportHeliportPropertyType", propOrder = {
...
public class AirportHeliportPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportheliport_pt_seq")
    @SequenceGenerator(name = "airportheliport_pt_seq", sequenceName = "airportheliport_pt_seq", allocationSize = 1)
