    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "doppler_value", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "doppler_nilreason", length = 255, nullable = true, unique = false))
    })
    protected CodeYesNoType doppler;
    @OneToMany(cascade = {
        CascadeType.ALL
    }, fetch = FetchType.EAGER)
    @JoinTable(name = "master_join", joinColumns = {
     ...
     *     
     */
    public CodeYesNoType getDoppler() {
        return doppler;
    }
     ...
     *     
     */
    public void setDoppler(CodeYesNoType value) {
        this.doppler = value;
    }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the informationProvision property.</p>
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * </p>
     ...
     * 
     * @return
     *     The value of the informationProvision property.
     */
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractdirectionfinderextension_id", referencedColumnName = "id")
