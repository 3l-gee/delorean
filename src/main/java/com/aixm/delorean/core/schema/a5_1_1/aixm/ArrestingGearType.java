...
@Entity
@Table(name = "arrestinggeartype", schema = "runway")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "arrestinggeartype_timeslice", joinColumns = {
        @JoinColumn(name = "arrestinggeartype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "arrestinggeartimeslicepropertytype_id")
    })
