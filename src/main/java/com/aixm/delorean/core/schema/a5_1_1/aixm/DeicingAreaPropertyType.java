...
@XmlType(name = "DeicingAreaPropertyType", propOrder = {
...
public class DeicingAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "deicingarea_pt_seq")
    @SequenceGenerator(name = "deicingarea_pt_seq", sequenceName = "deicingarea_pt_seq", allocationSize = 1)
