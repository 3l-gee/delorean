...
@Entity
@Table(name = "authority_for_special_navigation_system", schema = "public")
    ...
    extends AbstractAIXMObjectType
{
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstract_authority_for_special_navigation_system_extension_id", referencedColumnName = "id")
