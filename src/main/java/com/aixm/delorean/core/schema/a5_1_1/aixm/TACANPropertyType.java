...
@XmlType(name = "TACANPropertyType", propOrder = {

})
@Entity
@Table(name = "tacan_pt", schema = "navaids_points")
public class TACANPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tacan_pt_seq")
    @SequenceGenerator(name = "tacan_pt_seq", sequenceName = "tacan_pt_seq", allocationSize = 1)
