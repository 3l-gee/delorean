...
public class IntermediateLegTimeSlicePropertyType {
    ...
    @JoinColumn(name = "intermediatelegtimeslice_id", referencedColumnName = "id")
    protected IntermediateLegTimeSliceType intermediateLegTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "intermediateleg_tsp_seq")
    @SequenceGenerator(name = "intermediateleg_tsp_seq", sequenceName = "intermediateleg_tsp_seq", allocationSize = 1)
