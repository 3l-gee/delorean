...
public class SegmentLegPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "segmentleg_pt_seq")
    @SequenceGenerator(name = "segmentleg_pt_seq", sequenceName = "segmentleg_pt_seq", allocationSize = 1)
