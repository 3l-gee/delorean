...
@XmlType(name = "ArrestingGearPropertyType", propOrder = {
...
public class ArrestingGearPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "arrestinggear_pt_seq")
    @SequenceGenerator(name = "arrestinggear_pt_seq", sequenceName = "arrestinggear_pt_seq", allocationSize = 1)
