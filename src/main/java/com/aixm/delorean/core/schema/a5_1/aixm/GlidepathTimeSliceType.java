...
@Entity
@Table(name = "glidepath_ts", schema = "navaids_points")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "glidepath_ts_authority", joinColumns = {
        @JoinColumn(name = "glidepath_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "glidepath_ts_monitoring", joinColumns = {
        @JoinColumn(name = "glidepath_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "glidepath_ts_availability", joinColumns = {
        @JoinColumn(name = "glidepath_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "glidepath_ts_annotation", joinColumns = {
        @JoinColumn(name = "glidepath_ts_id")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rdh_value", length = 255, columnDefinition = "TEXT", nullable = true, unique = false)),
        @AttributeOverride(name = "uom", column = @Column(name = "rdh_uom", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rdh_nilreason", length = 255, nullable = true, unique = false))
    })
    protected ValDistanceVerticalType rdh;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "rdhaccuracy_value", length = 255, columnDefinition = "TEXT", nullable = true, unique = false)),
        @AttributeOverride(name = "uom", column = @Column(name = "rdhaccuracy_uom", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "rdhaccuracy_nilreason", length = 255, nullable = true, unique = false))
    })
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractglidepathextension_id", referencedColumnName = "id")
