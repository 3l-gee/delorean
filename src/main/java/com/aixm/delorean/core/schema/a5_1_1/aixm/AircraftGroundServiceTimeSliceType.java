    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "aircraftgroundservice_ts_call-sign", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aircraftgroundservice_ts_radiocommunication", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aircraftgroundservice_ts_groundcommunication", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aircraftgroundservice_ts_availability", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aircraftgroundservice_ts_annotation", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "aircraftgroundservice_ts_airportheliport", joinColumns = {
        @JoinColumn(name = "aircraftgroundservice_ts_id")
    }, inverseJoinColumns = {
