...
public class ApronTimeSlicePropertyType {
    ...
    @JoinColumn(name = "aprontimeslice_id", referencedColumnName = "id")
    protected ApronTimeSliceType apronTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "apron_tsp_seq")
    @SequenceGenerator(name = "apron_tsp_seq", sequenceName = "apron_tsp_seq", allocationSize = 1)
