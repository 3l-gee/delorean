...
@XmlType(name = "DMEPropertyType", propOrder = {

})
@Entity
@Table(name = "dme_pt", schema = "navaids_points")
public class DMEPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "dme_pt_seq")
    @SequenceGenerator(name = "dme_pt_seq", sequenceName = "dme_pt_seq", allocationSize = 1)
