...
@XmlType(name = "SafeAltitudeAreaPropertyType", propOrder = {
...
public class SafeAltitudeAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "safealtitudearea_pt_seq")
    @SequenceGenerator(name = "safealtitudearea_pt_seq", sequenceName = "safealtitudearea_pt_seq", allocationSize = 1)
