...
@XmlType(name = "FloatingDockSitePropertyType", propOrder = {
...
public class FloatingDockSitePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "floatingdocksite_pt_seq")
    @SequenceGenerator(name = "floatingdocksite_pt_seq", sequenceName = "floatingdocksite_pt_seq", allocationSize = 1)
