...
@XmlType(name = "SurveillanceRadarPropertyType", propOrder = {
...
public class SurveillanceRadarPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "surveillanceradar_pt_seq")
    @SequenceGenerator(name = "surveillanceradar_pt_seq", sequenceName = "surveillanceradar_pt_seq", allocationSize = 1)
