...
@Entity
@Table(name = "floatingdocksitetype", schema = "seaplanes")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "floatingdocksitetype_timeslice", joinColumns = {
        @JoinColumn(name = "floatingdocksitetype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "floatingdocksitetimeslicepropertytype_id")
    })
