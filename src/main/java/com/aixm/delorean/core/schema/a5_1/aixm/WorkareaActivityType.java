    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    @JoinTable(name = "workareaactivity_timeinterval", joinColumns = {
        @JoinColumn(name = "workareaactivity_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "workareaactivity_annotation", joinColumns = {
        @JoinColumn(name = "workareaactivity_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "workareaactivity_specialdateauthority", joinColumns = {
        @JoinColumn(name = "workareaactivity_id")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "isactive_value", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "isactive_nilreason", length = 255, nullable = true, unique = false))
    })
     ...
     *     
     */
    public CodeYesNoType getIsActive() {
        return isActive;
    }
     ...
     *     
     */
    public void setIsActive(CodeYesNoType value) {
        this.isActive = value;
    }
