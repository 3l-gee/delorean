...
@Entity
@Table(name = "checkpointinstype", schema = "navaids")
    ...
    extends AbstractNavigationSystemCheckpointType
{
    ...
    @JoinTable(name = "checkpointinstype_timeslice", joinColumns = {
        @JoinColumn(name = "checkpointinstype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "checkpointinstimeslicepropertytype_id")
    })
