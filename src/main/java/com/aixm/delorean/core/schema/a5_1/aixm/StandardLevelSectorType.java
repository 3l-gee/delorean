...
@Entity
@Table(name = "standardlevelsectortype", schema = "standard_levels")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "standardlevelsectortype_timeslice", joinColumns = {
        @JoinColumn(name = "standardlevelsectortype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "standardlevelsectortimeslicepropertytype_id")
    })
