...
@Entity
@Table(name = "runwaycentrelinepointtype", schema = "public")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "runwaycentrelinepointtype_timeslice", joinColumns = {
        @JoinColumn(name = "runwaycentrelinepointtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "runwaycentrelinepointtimeslicepropertytype_id")
    })
