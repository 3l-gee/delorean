...
public class PassengerServiceTimeSlicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "passengerservice_tsp_seq")
    @SequenceGenerator(name = "passengerservice_tsp_seq", sequenceName = "passengerservice_tsp_seq", allocationSize = 1)
