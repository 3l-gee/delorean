...
public class AirportClearanceServiceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airportclearanceservicetimeslice_id", referencedColumnName = "id")
    protected AirportClearanceServiceTimeSliceType airportClearanceServiceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportclearanceservice_tsp_seq")
    @SequenceGenerator(name = "airportclearanceservice_tsp_seq", sequenceName = "airportclearanceservice_tsp_seq", allocationSize = 1)
