...
@Entity
@Table(name = "standard_level_table_time_slice_type", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "standard_icao_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "standard_icao_nilreason"))
    })
