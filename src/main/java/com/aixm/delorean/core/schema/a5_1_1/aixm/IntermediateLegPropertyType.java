...
@XmlType(name = "IntermediateLegPropertyType", propOrder = {
...
public class IntermediateLegPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "intermediateleg_pt_seq")
    @SequenceGenerator(name = "intermediateleg_pt_seq", sequenceName = "intermediateleg_pt_seq", allocationSize = 1)
