...
public class AltimeterSourceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "altimetersourcetimeslice_id", referencedColumnName = "id")
    protected AltimeterSourceTimeSliceType altimeterSourceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "altimetersource_tsp_seq")
    @SequenceGenerator(name = "altimetersource_tsp_seq", sequenceName = "altimetersource_tsp_seq", allocationSize = 1)
