...
@XmlType(name = "RunwayBlastPadPropertyType", propOrder = {
...
public class RunwayBlastPadPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayblastpad_pt_seq")
    @SequenceGenerator(name = "runwayblastpad_pt_seq", sequenceName = "runwayblastpad_pt_seq", allocationSize = 1)
