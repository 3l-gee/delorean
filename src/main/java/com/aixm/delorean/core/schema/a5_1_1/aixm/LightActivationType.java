...
@Entity
@Table(name = "lightactivationtype", schema = "public")
    ...
    extends AbstractAIXMObjectType
{
    ...
    @JoinTable(name = "lightactivationpropertygroup_annotation", joinColumns = {
        @JoinColumn(name = "lightactivationpropertygroup_id")
    }, inverseJoinColumns = {
