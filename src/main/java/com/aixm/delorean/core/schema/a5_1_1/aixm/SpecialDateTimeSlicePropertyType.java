...
public class SpecialDateTimeSlicePropertyType {
    ...
    @JoinColumn(name = "specialdatetimeslice_id", referencedColumnName = "id")
    protected SpecialDateTimeSliceType specialDateTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "specialdate_tsp_seq")
    @SequenceGenerator(name = "specialdate_tsp_seq", sequenceName = "specialdate_tsp_seq", allocationSize = 1)
