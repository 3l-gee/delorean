...
public class AltimeterSourcePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "altimetersource_pt_seq")
    @SequenceGenerator(name = "altimetersource_pt_seq", sequenceName = "altimetersource_pt_seq", allocationSize = 1)
