...
public class RunwayVisualRangeTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwayvisualrangetimeslice_id", referencedColumnName = "id")
    protected RunwayVisualRangeTimeSliceType runwayVisualRangeTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayvisualrange_tsp_seq")
    @SequenceGenerator(name = "runwayvisualrange_tsp_seq", sequenceName = "runwayvisualrange_tsp_seq", allocationSize = 1)
