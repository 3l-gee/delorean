...
@XmlType(name = "TrafficSeparationServicePropertyType", propOrder = {
...
public class TrafficSeparationServicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "trafficseparationservice_pt_seq")
    @SequenceGenerator(name = "trafficseparationservice_pt_seq", sequenceName = "trafficseparationservice_pt_seq", allocationSize = 1)
