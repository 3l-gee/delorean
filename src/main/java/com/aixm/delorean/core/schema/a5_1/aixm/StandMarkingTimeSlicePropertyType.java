...
public class StandMarkingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "standmarkingtimeslice_id", referencedColumnName = "id")
    protected StandMarkingTimeSliceType standMarkingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standmarking_tsp_seq")
    @SequenceGenerator(name = "standmarking_tsp_seq", sequenceName = "standmarking_tsp_seq", allocationSize = 1)
