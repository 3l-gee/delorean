...
@XmlType(name = "MarkingPropertyType", propOrder = {
...
public class MarkingPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "marking_pt_seq")
    @SequenceGenerator(name = "marking_pt_seq", sequenceName = "marking_pt_seq", allocationSize = 1)
