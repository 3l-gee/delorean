...
public class UnitTimeSlicePropertyType {
    ...
    @JoinColumn(name = "unittimeslice_id", referencedColumnName = "id")
    protected UnitTimeSliceType unitTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "unit_tsp_seq")
    @SequenceGenerator(name = "unit_tsp_seq", sequenceName = "unit_tsp_seq", allocationSize = 1)
