...
@XmlType(name = "CheckpointINSPropertyType", propOrder = {

})
@Entity
@Table(name = "checkpointins_pt", schema = "navaids_points")
public class CheckpointINSPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "checkpointins_pt_seq")
    @SequenceGenerator(name = "checkpointins_pt_seq", sequenceName = "checkpointins_pt_seq", allocationSize = 1)
