...
public class RadioFrequencyAreaTimeSlicePropertyType {
    ...
    @JoinColumn(name = "radiofrequencyareatimeslice_id", referencedColumnName = "id")
    protected RadioFrequencyAreaTimeSliceType radioFrequencyAreaTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "radiofrequencyarea_tsp_seq")
    @SequenceGenerator(name = "radiofrequencyarea_tsp_seq", sequenceName = "radiofrequencyarea_tsp_seq", allocationSize = 1)
