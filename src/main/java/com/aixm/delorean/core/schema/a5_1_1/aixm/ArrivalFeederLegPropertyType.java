...
@XmlType(name = "ArrivalFeederLegPropertyType", propOrder = {
...
public class ArrivalFeederLegPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "arrivalfeederleg_pt_seq")
    @SequenceGenerator(name = "arrivalfeederleg_pt_seq", sequenceName = "arrivalfeederleg_pt_seq", allocationSize = 1)
