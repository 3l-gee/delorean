...
public class TaxiwayTimeSlicePropertyType {
    ...
    @JoinColumn(name = "taxiwaytimeslice_id", referencedColumnName = "id")
    protected TaxiwayTimeSliceType taxiwayTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiway_tsp_seq")
    @SequenceGenerator(name = "taxiway_tsp_seq", sequenceName = "taxiway_tsp_seq", allocationSize = 1)
