...
public class AirspaceBorderCrossingPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airspacebordercrossing_pt_seq")
    @SequenceGenerator(name = "airspacebordercrossing_pt_seq", sequenceName = "airspacebordercrossing_pt_seq", allocationSize = 1)
