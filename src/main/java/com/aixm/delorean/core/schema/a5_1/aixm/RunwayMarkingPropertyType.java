...
@XmlType(name = "RunwayMarkingPropertyType", propOrder = {
...
public class RunwayMarkingPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwaymarking_pt_seq")
    @SequenceGenerator(name = "runwaymarking_pt_seq", sequenceName = "runwaymarking_pt_seq", allocationSize = 1)
