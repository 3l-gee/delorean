...
@XmlType(name = "CirclingAreaPropertyType", propOrder = {
...
public class CirclingAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "circlingarea_pt_seq")
    @SequenceGenerator(name = "circlingarea_pt_seq", sequenceName = "circlingarea_pt_seq", allocationSize = 1)
