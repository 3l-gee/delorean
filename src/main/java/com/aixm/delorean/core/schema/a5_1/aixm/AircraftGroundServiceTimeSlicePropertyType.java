...
public class AircraftGroundServiceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "aircraftgroundservicetimeslice_id", referencedColumnName = "id")
    protected AircraftGroundServiceTimeSliceType aircraftGroundServiceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "aircraftgroundservice_tsp_seq")
    @SequenceGenerator(name = "aircraftgroundservice_tsp_seq", sequenceName = "aircraftgroundservice_tsp_seq", allocationSize = 1)
