    ...
    extends AbstractGroundLightSystemType
{
    ...
    @JoinTable(name = "apronlightsystemtype_timeslice", joinColumns = {
        @JoinColumn(name = "apronlightsystemtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "apronlightsystemtimeslicepropertytype_id")
    })
