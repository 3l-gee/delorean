...
@XmlType(name = "HoldingAssessmentPropertyType", propOrder = {
...
public class HoldingAssessmentPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "holdingassessment_pt_seq")
    @SequenceGenerator(name = "holdingassessment_pt_seq", sequenceName = "holdingassessment_pt_seq", allocationSize = 1)
