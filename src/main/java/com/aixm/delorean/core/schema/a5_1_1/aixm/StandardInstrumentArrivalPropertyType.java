...
@XmlType(name = "StandardInstrumentArrivalPropertyType", propOrder = {
...
public class StandardInstrumentArrivalPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardinstrumentarrival_pt_seq")
    @SequenceGenerator(name = "standardinstrumentarrival_pt_seq", sequenceName = "standardinstrumentarrival_pt_seq", allocationSize = 1)
