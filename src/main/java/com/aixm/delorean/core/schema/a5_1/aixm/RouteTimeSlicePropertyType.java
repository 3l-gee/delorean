...
public class RouteTimeSlicePropertyType {
    ...
    @JoinColumn(name = "routetimeslice_id", referencedColumnName = "id")
    protected RouteTimeSliceType routeTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "route_tsp_seq")
    @SequenceGenerator(name = "route_tsp_seq", sequenceName = "route_tsp_seq", allocationSize = 1)
