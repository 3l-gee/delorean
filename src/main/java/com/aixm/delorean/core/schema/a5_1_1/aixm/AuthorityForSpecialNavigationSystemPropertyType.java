...
@Entity
@Table(name = "authority_for_special_navigation_system_property", schema = "public")
    ...
    extends AbstractAIXMPropertyType
{
    ...
    @JoinColumn(name = "authority_for_special_navigation_system_id", referencedColumnName = "id")
