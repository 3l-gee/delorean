...
@Entity
@Table(name = "checkpointvor_tsp", schema = "navaids_points")
public class CheckpointVORTimeSlicePropertyType {
    ...
    @JoinColumn(name = "checkpointvortimeslice_id", referencedColumnName = "id")
    protected CheckpointVORTimeSliceType checkpointVORTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "checkpointvor_tsp_seq")
    @SequenceGenerator(name = "checkpointvor_tsp_seq", sequenceName = "checkpointvor_tsp_seq", allocationSize = 1)
