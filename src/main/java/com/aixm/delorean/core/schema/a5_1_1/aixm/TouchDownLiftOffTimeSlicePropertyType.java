...
public class TouchDownLiftOffTimeSlicePropertyType {
    ...
    @JoinColumn(name = "touchdownliftofftimeslice_id", referencedColumnName = "id")
    protected TouchDownLiftOffTimeSliceType touchDownLiftOffTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "touchdownliftoff_tsp_seq")
    @SequenceGenerator(name = "touchdownliftoff_tsp_seq", sequenceName = "touchdownliftoff_tsp_seq", allocationSize = 1)
