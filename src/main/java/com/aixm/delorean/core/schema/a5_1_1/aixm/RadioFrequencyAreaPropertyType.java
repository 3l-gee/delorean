...
@XmlType(name = "RadioFrequencyAreaPropertyType", propOrder = {
...
public class RadioFrequencyAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "radiofrequencyarea_pt_seq")
    @SequenceGenerator(name = "radiofrequencyarea_pt_seq", sequenceName = "radiofrequencyarea_pt_seq", allocationSize = 1)
