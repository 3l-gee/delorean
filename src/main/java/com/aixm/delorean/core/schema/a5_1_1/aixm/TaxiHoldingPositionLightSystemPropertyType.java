...
@XmlType(name = "TaxiHoldingPositionLightSystemPropertyType", propOrder = {
...
public class TaxiHoldingPositionLightSystemPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiholdingpositionlightsystem_pt_seq")
    @SequenceGenerator(name = "taxiholdingpositionlightsystem_pt_seq", sequenceName = "taxiholdingpositionlightsystem_pt_seq", allocationSize = 1)
