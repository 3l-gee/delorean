...
@XmlType(name = "PrimarySurveillanceRadarPropertyType", propOrder = {
...
public class PrimarySurveillanceRadarPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "primarysurveillanceradar_pt_seq")
    @SequenceGenerator(name = "primarysurveillanceradar_pt_seq", sequenceName = "primarysurveillanceradar_pt_seq", allocationSize = 1)
