...
@Entity
@Table(name = "routesegmenttype", schema = "en_route")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "routesegmenttype_timeslice", joinColumns = {
        @JoinColumn(name = "routesegmenttype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "routesegmenttimeslicepropertytype_id")
    })
