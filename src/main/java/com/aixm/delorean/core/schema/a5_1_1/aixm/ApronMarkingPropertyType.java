...
@XmlType(name = "ApronMarkingPropertyType", propOrder = {
...
public class ApronMarkingPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "apronmarking_pt_seq")
    @SequenceGenerator(name = "apronmarking_pt_seq", sequenceName = "apronmarking_pt_seq", allocationSize = 1)
