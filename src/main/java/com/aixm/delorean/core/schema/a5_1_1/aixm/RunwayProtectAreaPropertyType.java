...
@XmlType(name = "RunwayProtectAreaPropertyType", propOrder = {
...
public class RunwayProtectAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayprotectarea_pt_seq")
    @SequenceGenerator(name = "runwayprotectarea_pt_seq", sequenceName = "runwayprotectarea_pt_seq", allocationSize = 1)
