...
@XmlType(name = "TaxiwayPropertyType", propOrder = {
...
public class TaxiwayPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiway_pt_seq")
    @SequenceGenerator(name = "taxiway_pt_seq", sequenceName = "taxiway_pt_seq", allocationSize = 1)
