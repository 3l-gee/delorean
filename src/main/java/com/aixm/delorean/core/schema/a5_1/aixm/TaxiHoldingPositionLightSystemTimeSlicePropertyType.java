...
public class TaxiHoldingPositionLightSystemTimeSlicePropertyType {
    ...
    @JoinColumn(name = "taxiholdingpositionlightsystemtimeslice_id", referencedColumnName = "id")
    protected TaxiHoldingPositionLightSystemTimeSliceType taxiHoldingPositionLightSystemTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiholdingpositionlightsystem_tsp_seq")
    @SequenceGenerator(name = "taxiholdingpositionlightsystem_tsp_seq", sequenceName = "taxiholdingpositionlightsystem_tsp_seq", allocationSize = 1)
