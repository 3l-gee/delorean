...
@Entity
@Table(name = "checkpointvortype", schema = "navaids")
    ...
    extends AbstractNavigationSystemCheckpointType
{
    ...
    @JoinTable(name = "checkpointvortype_timeslice", joinColumns = {
        @JoinColumn(name = "checkpointvortype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "checkpointvortimeslicepropertytype_id")
    })
