...
public class VORTimeSlicePropertyType {
    ...
    @JoinColumn(name = "vortimeslice_id", referencedColumnName = "id")
    protected VORTimeSliceType vorTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "vor_tsp_seq")
    @SequenceGenerator(name = "vor_tsp_seq", sequenceName = "vor_tsp_seq", allocationSize = 1)
