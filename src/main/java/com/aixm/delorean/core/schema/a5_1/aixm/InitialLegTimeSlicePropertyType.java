...
public class InitialLegTimeSlicePropertyType {
    ...
    @JoinColumn(name = "initiallegtimeslice_id", referencedColumnName = "id")
    protected InitialLegTimeSliceType initialLegTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "initialleg_tsp_seq")
    @SequenceGenerator(name = "initialleg_tsp_seq", sequenceName = "initialleg_tsp_seq", allocationSize = 1)
