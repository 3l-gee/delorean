    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "surveycontrolpointtype_timeslice", joinColumns = {
        @JoinColumn(name = "surveycontrolpointtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "surveycontrolpointtimeslicepropertytype_id")
    })
