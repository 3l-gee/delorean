...
public class RoadTimeSlicePropertyType {
    ...
    @JoinColumn(name = "roadtimeslice_id", referencedColumnName = "id")
    protected RoadTimeSliceType roadTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "road_tsp_seq")
    @SequenceGenerator(name = "road_tsp_seq", sequenceName = "road_tsp_seq", allocationSize = 1)
