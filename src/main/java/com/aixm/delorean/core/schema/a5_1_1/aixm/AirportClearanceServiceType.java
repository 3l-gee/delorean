...
@Entity
@Table(name = "airportclearanceservicetype", schema = "service")
    ...
    extends AbstractAirportGroundServiceType
{
    ...
    @JoinTable(name = "airportclearanceservicetype_timeslice", joinColumns = {
        @JoinColumn(name = "airportclearanceservicetype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "airportclearanceservicetimeslicepropertytype_id")
    })
