    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "arrivalleg_ts_aircraftcategory", joinColumns = {
        @JoinColumn(name = "arrivalleg_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrivalleg_ts_designsurface", joinColumns = {
        @JoinColumn(name = "arrivalleg_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "arrivalleg_ts_annotation", joinColumns = {
        @JoinColumn(name = "arrivalleg_ts_id")
    }, inverseJoinColumns = {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractarrivallegextension_id", referencedColumnName = "id")
