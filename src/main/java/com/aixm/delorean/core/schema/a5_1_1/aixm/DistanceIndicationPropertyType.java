...
@XmlType(name = "DistanceIndicationPropertyType", propOrder = {

})
@Entity
@Table(name = "distanceindication_pt", schema = "navaids_points")
public class DistanceIndicationPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "distanceindication_pt_seq")
    @SequenceGenerator(name = "distanceindication_pt_seq", sequenceName = "distanceindication_pt_seq", allocationSize = 1)
