...
public class PilotControlledLightingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "pilotcontrolledlightingtimeslice_id", referencedColumnName = "id")
    protected PilotControlledLightingTimeSliceType pilotControlledLightingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "pilotcontrolledlighting_tsp_seq")
    @SequenceGenerator(name = "pilotcontrolledlighting_tsp_seq", sequenceName = "pilotcontrolledlighting_tsp_seq", allocationSize = 1)
