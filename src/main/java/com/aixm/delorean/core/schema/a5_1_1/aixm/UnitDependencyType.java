...
@Entity
@Table(name = "unitdependencytype", schema = "public")
    ...
    extends AbstractAIXMObjectType
{
    ...
    @JoinTable(name = "unitdependencypropertygroup_annotation", joinColumns = {
        @JoinColumn(name = "unitdependencypropertygroup_id")
    }, inverseJoinColumns = {
