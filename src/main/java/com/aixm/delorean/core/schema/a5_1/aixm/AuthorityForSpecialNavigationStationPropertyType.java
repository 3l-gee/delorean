...
@Entity
@Table(name = "authorityforspecialnavigationstation_pt", schema = "navaids_points")
    ...
    extends AbstractAIXMPropertyType
{
    ...
    @JoinColumn(name = "authorityforspecialnavigationstation_id", referencedColumnName = "id")
