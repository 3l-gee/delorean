    ...
    extends AbstractSurfaceContaminationType
{
    ...
    @JoinTable(name = "runwaysectioncontamination_criticalridge", joinColumns = {
        @JoinColumn(name = "runwaysectioncontamination_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "runwaysectioncontamination_layer", joinColumns = {
        @JoinColumn(name = "runwaysectioncontamination_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "runwaysectioncontamination_annotation", joinColumns = {
        @JoinColumn(name = "runwaysectioncontamination_id")
    }, inverseJoinColumns = {
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "nilReason", column = @Column(name = "section_nilreason", length = 255, nullable = true, unique = false))
    })
    protected CodeRunwaySectionType section;
    @Transient
     ...
     *     
     */
    public void setSection(CodeRunwaySectionType value) {
        this.section = value;
    }
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractrunwaysectioncontaminationextension_id", referencedColumnName = "id")
