...
@XmlType(name = "NDBPropertyType", propOrder = {

})
@Entity
@Table(name = "ndb_pt", schema = "navaids_points")
public class NDBPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ndb_pt_seq")
    @SequenceGenerator(name = "ndb_pt_seq", sequenceName = "ndb_pt_seq", allocationSize = 1)
