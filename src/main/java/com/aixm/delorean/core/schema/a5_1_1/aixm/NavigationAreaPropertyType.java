...
@XmlType(name = "NavigationAreaPropertyType", propOrder = {
...
public class NavigationAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "navigationarea_pt_seq")
    @SequenceGenerator(name = "navigationarea_pt_seq", sequenceName = "navigationarea_pt_seq", allocationSize = 1)
