...
@Entity
@Table(name = "aircraftgroundservicetype", schema = "service")
    ...
    extends AbstractAirportGroundServiceType
{
    ...
    @JoinTable(name = "aircraftgroundservicetype_timeslice", joinColumns = {
        @JoinColumn(name = "aircraftgroundservicetype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "aircraftgroundservicetimeslicepropertytype_id")
    })
