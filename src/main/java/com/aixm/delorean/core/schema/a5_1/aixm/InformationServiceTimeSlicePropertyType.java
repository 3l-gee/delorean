...
public class InformationServiceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "informationservicetimeslice_id", referencedColumnName = "id")
    protected InformationServiceTimeSliceType informationServiceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "informationservice_tsp_seq")
    @SequenceGenerator(name = "informationservice_tsp_seq", sequenceName = "informationservice_tsp_seq", allocationSize = 1)
