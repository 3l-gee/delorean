...
@Entity
@Table(name = "en_route_segment_point", schema = "public")
    ...
    extends AbstractSegmentPointType
{
    ...
    @JoinColumn(name = "facility_makeup_id", referencedColumnName = "id")
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstract_segment_point_extension_id", referencedColumnName = "id")
        protected AbstractExtensionType abstractSegmentPointExtension;
        @XmlElement(name = "AbstractEnRouteSegmentPointExtension")
        @OneToOne(cascade = {
            CascadeType.ALL
        }, fetch = FetchType.EAGER)
        @JoinColumn(name = "abstract_en_route_segment_point_extension_id", referencedColumnName = "id")
