 ...
 * 
 * <p>Java class for AxisDirectionList simple type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <simpleType name="AxisDirectionList">
 *   <list itemType="{http://www.opengis.net/gml/3.2}AxisDirection" />
 * </simpleType>
 * }</pre>
 * 
 * 
...
@XmlType(name = "AxisDirectionList", propOrder = {
    "value"
})
public class AxisDirectionList {
     ...
     */
    @XmlValue
    protected List<AxisDirection> value;
     ...
     */
    public List<AxisDirection> getValue() {
        if (value == null) {
            value = new ArrayList<>();
        }
        return this.value;
