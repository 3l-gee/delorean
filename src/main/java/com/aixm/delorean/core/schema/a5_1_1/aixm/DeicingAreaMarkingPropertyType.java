...
@XmlType(name = "DeicingAreaMarkingPropertyType", propOrder = {
...
public class DeicingAreaMarkingPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "deicingareamarking_pt_seq")
    @SequenceGenerator(name = "deicingareamarking_pt_seq", sequenceName = "deicingareamarking_pt_seq", allocationSize = 1)
