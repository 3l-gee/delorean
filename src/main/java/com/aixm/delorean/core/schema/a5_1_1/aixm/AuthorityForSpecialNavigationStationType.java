...
@Entity
@Table(name = "authority_for_special_navigation_station", schema = "public")
    ...
    extends AbstractAIXMObjectType
{
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstract_authority_for_special_navigation_station_extension_id", referencedColumnName = "id")
