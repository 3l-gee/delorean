...
@Entity
@Table(name = "tacantype", schema = "navaids")
    ...
    extends AbstractNavaidEquipmentType
{
    ...
    @JoinTable(name = "tacantype_timeslice", joinColumns = {
        @JoinColumn(name = "tacantype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "tacantimeslicepropertytype_id")
    })
