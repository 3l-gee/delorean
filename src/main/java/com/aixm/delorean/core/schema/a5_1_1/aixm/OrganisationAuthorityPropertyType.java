...
@XmlType(name = "OrganisationAuthorityPropertyType", propOrder = {
...
public class OrganisationAuthorityPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "organisationauthority_pt_seq")
    @SequenceGenerator(name = "organisationauthority_pt_seq", sequenceName = "organisationauthority_pt_seq", allocationSize = 1)
