...
public class StandardInstrumentArrivalTimeSlicePropertyType {
    ...
    @JoinColumn(name = "standardinstrumentarrivaltimeslice_id", referencedColumnName = "id")
    protected StandardInstrumentArrivalTimeSliceType standardInstrumentArrivalTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardinstrumentarrival_tsp_seq")
    @SequenceGenerator(name = "standardinstrumentarrival_tsp_seq", sequenceName = "standardinstrumentarrival_tsp_seq", allocationSize = 1)
