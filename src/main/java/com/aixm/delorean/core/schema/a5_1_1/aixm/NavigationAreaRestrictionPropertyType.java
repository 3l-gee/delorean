...
@XmlType(name = "NavigationAreaRestrictionPropertyType", propOrder = {
...
public class NavigationAreaRestrictionPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "navigationarearestriction_pt_seq")
    @SequenceGenerator(name = "navigationarearestriction_pt_seq", sequenceName = "navigationarearestriction_pt_seq", allocationSize = 1)
