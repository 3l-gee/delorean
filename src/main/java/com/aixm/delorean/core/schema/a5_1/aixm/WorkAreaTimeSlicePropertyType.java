...
public class WorkAreaTimeSlicePropertyType {
    ...
    @JoinColumn(name = "workareatimeslice_id", referencedColumnName = "id")
    protected WorkAreaTimeSliceType workAreaTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "workarea_tsp_seq")
    @SequenceGenerator(name = "workarea_tsp_seq", sequenceName = "workarea_tsp_seq", allocationSize = 1)
