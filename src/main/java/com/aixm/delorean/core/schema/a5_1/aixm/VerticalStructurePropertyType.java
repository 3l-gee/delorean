...
@XmlType(name = "VerticalStructurePropertyType", propOrder = {
...
public class VerticalStructurePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "verticalstructure_pt_seq")
    @SequenceGenerator(name = "verticalstructure_pt_seq", sequenceName = "verticalstructure_pt_seq", allocationSize = 1)
