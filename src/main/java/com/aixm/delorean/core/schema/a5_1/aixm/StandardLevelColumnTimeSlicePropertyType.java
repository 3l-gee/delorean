...
public class StandardLevelColumnTimeSlicePropertyType {
    ...
    @JoinColumn(name = "standardlevelcolumntimeslice_id", referencedColumnName = "id")
    protected StandardLevelColumnTimeSliceType standardLevelColumnTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardlevelcolumn_tsp_seq")
    @SequenceGenerator(name = "standardlevelcolumn_tsp_seq", sequenceName = "standardlevelcolumn_tsp_seq", allocationSize = 1)
