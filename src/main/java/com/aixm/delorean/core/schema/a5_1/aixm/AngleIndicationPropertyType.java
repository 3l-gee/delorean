...
@XmlType(name = "AngleIndicationPropertyType", propOrder = {
...
public class AngleIndicationPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "angleindication_pt_seq")
    @SequenceGenerator(name = "angleindication_pt_seq", sequenceName = "angleindication_pt_seq", allocationSize = 1)
