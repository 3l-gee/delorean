...
@XmlType(name = "LocalizerPropertyType", propOrder = {

})
@Entity
@Table(name = "localizer_pt", schema = "navaids_points")
public class LocalizerPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "localizer_pt_seq")
    @SequenceGenerator(name = "localizer_pt_seq", sequenceName = "localizer_pt_seq", allocationSize = 1)
