...
public class DirectionFinderTimeSlicePropertyType {
    ...
    @JoinColumn(name = "directionfindertimeslice_id", referencedColumnName = "id")
    protected DirectionFinderTimeSliceType directionFinderTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "directionfinder_tsp_seq")
    @SequenceGenerator(name = "directionfinder_tsp_seq", sequenceName = "directionfinder_tsp_seq", allocationSize = 1)
