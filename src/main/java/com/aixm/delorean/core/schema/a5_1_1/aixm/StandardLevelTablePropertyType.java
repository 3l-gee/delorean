...
@XmlType(name = "StandardLevelTablePropertyType", propOrder = {
...
public class StandardLevelTablePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardleveltable_pt_seq")
    @SequenceGenerator(name = "standardleveltable_pt_seq", sequenceName = "standardleveltable_pt_seq", allocationSize = 1)
