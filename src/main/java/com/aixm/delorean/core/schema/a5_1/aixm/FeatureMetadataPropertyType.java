    ...
    extends AbstractMetadataPropertyType
{
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "feature_metadata_property_seq")
    @SequenceGenerator(name = "feature_metadata_property_seq", sequenceName = "feature_metadata_property_seq", allocationSize = 1)
