...
@XmlType(name = "SurveyControlPointPropertyType", propOrder = {
...
public class SurveyControlPointPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "surveycontrolpoint_pt_seq")
    @SequenceGenerator(name = "surveycontrolpoint_pt_seq", sequenceName = "surveycontrolpoint_pt_seq", allocationSize = 1)
