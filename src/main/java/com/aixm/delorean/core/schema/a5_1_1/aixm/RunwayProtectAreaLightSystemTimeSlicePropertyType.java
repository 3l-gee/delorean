...
@Entity
@Table(name = "runway_protect_area_light_system_slice_property", schema = "public")
public class RunwayProtectAreaLightSystemTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runway_protect_area_light_system_slice_id", referencedColumnName = "id")
