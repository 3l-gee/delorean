...
public class RunwayElementTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwayelementtimeslice_id", referencedColumnName = "id")
    protected RunwayElementTimeSliceType runwayElementTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayelement_tsp_seq")
    @SequenceGenerator(name = "runwayelement_tsp_seq", sequenceName = "runwayelement_tsp_seq", allocationSize = 1)
