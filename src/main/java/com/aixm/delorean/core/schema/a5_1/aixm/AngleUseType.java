...
@Entity
@Table(name = "angleuse", schema = "navaids_points")
    ...
    extends AbstractAIXMObjectType
{
    ...
    @JoinTable(name = "angleuse_annotation", joinColumns = {
        @JoinColumn(name = "angleuse_id")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "theangleindication_id", referencedColumnName = "id")
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractangleuseextension_id", referencedColumnName = "id")
