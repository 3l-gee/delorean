...
public class RulesProceduresTimeSlicePropertyType {
    ...
    @JoinColumn(name = "rulesprocedurestimeslice_id", referencedColumnName = "id")
    protected RulesProceduresTimeSliceType rulesProceduresTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "rulesprocedures_tsp_seq")
    @SequenceGenerator(name = "rulesprocedures_tsp_seq", sequenceName = "rulesprocedures_tsp_seq", allocationSize = 1)
