...
@XmlType(name = "StandMarkingPropertyType", propOrder = {
...
public class StandMarkingPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standmarking_pt_seq")
    @SequenceGenerator(name = "standmarking_pt_seq", sequenceName = "standmarking_pt_seq", allocationSize = 1)
