...
@Entity
@Table(name = "ground_traffic_control_service_time_slice_type")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    public static class Extension {
        ...
        @Column(name = "aixm:_abstract_ground_traffic_control_service_extension")
