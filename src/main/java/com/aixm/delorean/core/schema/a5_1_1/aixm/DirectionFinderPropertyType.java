...
@XmlType(name = "DirectionFinderPropertyType", propOrder = {

})
@Entity
@Table(name = "directionfinder_pt", schema = "navaids_points")
public class DirectionFinderPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "directionfinder_pt_seq")
    @SequenceGenerator(name = "directionfinder_pt_seq", sequenceName = "directionfinder_pt_seq", allocationSize = 1)
