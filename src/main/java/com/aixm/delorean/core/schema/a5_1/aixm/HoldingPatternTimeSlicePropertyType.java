...
public class HoldingPatternTimeSlicePropertyType {
    ...
    @JoinColumn(name = "holdingpatterntimeslice_id", referencedColumnName = "id")
    protected HoldingPatternTimeSliceType holdingPatternTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "holdingpattern_tsp_seq")
    @SequenceGenerator(name = "holdingpattern_tsp_seq", sequenceName = "holdingpattern_tsp_seq", allocationSize = 1)
