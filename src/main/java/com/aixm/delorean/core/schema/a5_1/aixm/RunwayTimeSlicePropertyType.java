...
public class RunwayTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwaytimeslice_id", referencedColumnName = "id")
    protected RunwayTimeSliceType runwayTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runway_tsp_seq")
    @SequenceGenerator(name = "runway_tsp_seq", sequenceName = "runway_tsp_seq", allocationSize = 1)
