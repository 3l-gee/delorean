    ...
    extends AbstractAirportGroundServiceType
{
    ...
    @JoinTable(name = "passengerservicetype_timeslice", joinColumns = {
        @JoinColumn(name = "passengerservicetype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "passengerservicetimeslicepropertytype_id")
    })
