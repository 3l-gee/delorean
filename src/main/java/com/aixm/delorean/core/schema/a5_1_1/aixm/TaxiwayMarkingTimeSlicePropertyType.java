...
public class TaxiwayMarkingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "taxiwaymarkingtimeslice_id", referencedColumnName = "id")
    protected TaxiwayMarkingTimeSliceType taxiwayMarkingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiwaymarking_tsp_seq")
    @SequenceGenerator(name = "taxiwaymarking_tsp_seq", sequenceName = "taxiwaymarking_tsp_seq", allocationSize = 1)
