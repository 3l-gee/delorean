...
@XmlType(name = "AirTrafficManagementServicePropertyType", propOrder = {
...
public class AirTrafficManagementServicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airtrafficmanagementservice_pt_seq")
    @SequenceGenerator(name = "airtrafficmanagementservice_pt_seq", sequenceName = "airtrafficmanagementservice_pt_seq", allocationSize = 1)
