...
@Entity
@Table(name = "azimuth_tsp", schema = "navaids_points")
public class AzimuthTimeSlicePropertyType {
    ...
    @JoinColumn(name = "azimuthtimeslice_id", referencedColumnName = "id")
    protected AzimuthTimeSliceType azimuthTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "azimuth_tsp_seq")
    @SequenceGenerator(name = "azimuth_tsp_seq", sequenceName = "azimuth_tsp_seq", allocationSize = 1)
