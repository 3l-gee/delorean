...
@Entity
@Table(name = "standard_instrument_departure_time_slice_type", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "contingency_route_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "contingency_route_nilreason"))
    })
