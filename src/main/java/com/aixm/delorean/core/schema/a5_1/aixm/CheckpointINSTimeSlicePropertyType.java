...
@Entity
@Table(name = "checkpointins_tsp", schema = "navaids_points")
public class CheckpointINSTimeSlicePropertyType {
    ...
    @JoinColumn(name = "checkpointinstimeslice_id", referencedColumnName = "id")
    protected CheckpointINSTimeSliceType checkpointINSTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "checkpointins_tsp_seq")
    @SequenceGenerator(name = "checkpointins_tsp_seq", sequenceName = "checkpointins_tsp_seq", allocationSize = 1)
