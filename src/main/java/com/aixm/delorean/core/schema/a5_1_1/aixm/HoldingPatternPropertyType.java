...
@XmlType(name = "HoldingPatternPropertyType", propOrder = {
...
public class HoldingPatternPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "holdingpattern_pt_seq")
    @SequenceGenerator(name = "holdingpattern_pt_seq", sequenceName = "holdingpattern_pt_seq", allocationSize = 1)
