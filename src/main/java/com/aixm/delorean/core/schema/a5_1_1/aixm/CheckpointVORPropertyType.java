...
@XmlType(name = "CheckpointVORPropertyType", propOrder = {

})
@Entity
@Table(name = "checkpointvor_pt", schema = "navaids_points")
public class CheckpointVORPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "checkpointvor_pt_seq")
    @SequenceGenerator(name = "checkpointvor_pt_seq", sequenceName = "checkpointvor_pt_seq", allocationSize = 1)
