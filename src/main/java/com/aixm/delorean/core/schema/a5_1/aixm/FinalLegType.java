...
@Entity
@Table(name = "finallegtype", schema = "procedure")
    ...
    extends AbstractApproachLegType
{
    ...
    @JoinTable(name = "finallegtype_timeslice", joinColumns = {
        @JoinColumn(name = "finallegtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "finallegtimeslicepropertytype_id")
    })
