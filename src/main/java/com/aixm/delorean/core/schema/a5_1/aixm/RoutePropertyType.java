...
@XmlType(name = "RoutePropertyType", propOrder = {

})
@Entity
@Table(name = "route_pt", schema = "routes")
public class RoutePropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "route_pt_seq")
    @SequenceGenerator(name = "route_pt_seq", sequenceName = "route_pt_seq", allocationSize = 1)
