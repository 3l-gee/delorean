    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "missedapproachleg_ts_aircraftcategory", joinColumns = {
        @JoinColumn(name = "missedapproachleg_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "missedapproachleg_ts_designsurface", joinColumns = {
        @JoinColumn(name = "missedapproachleg_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "missedapproachleg_ts_annotation", joinColumns = {
        @JoinColumn(name = "missedapproachleg_ts_id")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "thresholdaftermapt_value", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "thresholdaftermapt_nilreason", length = 255, nullable = true, unique = false))
    })
    protected CodeYesNoType thresholdAfterMAPT;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "heightmapt_value", length = 255, columnDefinition = "TEXT", nullable = true, unique = false)),
        @AttributeOverride(name = "uom", column = @Column(name = "heightmapt_uom", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "heightmapt_nilreason", length = 255, nullable = true, unique = false))
    })
    ...
    @JoinTable(name = "missedapproachleg_pg_condition_", joinColumns = {
        @JoinColumn(name = "missedapproachleg_pg_id")
    }, inverseJoinColumns = {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractmissedapproachlegextension_id", referencedColumnName = "id")
