...
public class RunwayProtectAreaLightSystemTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwayprotectarealightsystemtimeslice_id", referencedColumnName = "id")
    protected RunwayProtectAreaLightSystemTimeSliceType runwayProtectAreaLightSystemTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayprotectarealightsystem_tsp_seq")
    @SequenceGenerator(name = "runwayprotectarealightsystem_tsp_seq", sequenceName = "runwayprotectarealightsystem_tsp_seq", allocationSize = 1)
