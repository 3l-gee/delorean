...
@Entity
@Table(name = "aircraftstandcontaminationtype", schema = "surface_contamination")
    ...
    extends AbstractSurfaceContaminationType
{
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractaircraftstandcontaminationextension_id", referencedColumnName = "id")
