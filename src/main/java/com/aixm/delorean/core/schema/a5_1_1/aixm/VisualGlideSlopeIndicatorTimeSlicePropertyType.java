...
public class VisualGlideSlopeIndicatorTimeSlicePropertyType {
    ...
    @JoinColumn(name = "visualglideslopeindicatortimeslice_id", referencedColumnName = "id")
    protected VisualGlideSlopeIndicatorTimeSliceType visualGlideSlopeIndicatorTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "visualglideslopeindicator_tsp_seq")
    @SequenceGenerator(name = "visualglideslopeindicator_tsp_seq", sequenceName = "visualglideslopeindicator_tsp_seq", allocationSize = 1)
