...
public class FloatingDockSiteTimeSlicePropertyType {
    ...
    @JoinColumn(name = "floatingdocksitetimeslice_id", referencedColumnName = "id")
    protected FloatingDockSiteTimeSliceType floatingDockSiteTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "floatingdocksite_tsp_seq")
    @SequenceGenerator(name = "floatingdocksite_tsp_seq", sequenceName = "floatingdocksite_tsp_seq", allocationSize = 1)
