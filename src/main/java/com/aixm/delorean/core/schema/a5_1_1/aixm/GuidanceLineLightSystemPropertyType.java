...
@XmlType(name = "GuidanceLineLightSystemPropertyType", propOrder = {
...
public class GuidanceLineLightSystemPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "guidancelinelightsystem_pt_seq")
    @SequenceGenerator(name = "guidancelinelightsystem_pt_seq", sequenceName = "guidancelinelightsystem_pt_seq", allocationSize = 1)
