...
public class ArrivalLegTimeSlicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "arrivalleg_tsp_seq")
    @SequenceGenerator(name = "arrivalleg_tsp_seq", sequenceName = "arrivalleg_tsp_seq", allocationSize = 1)
