...
@XmlType(name = "SignificantPointInAirspacePropertyType", propOrder = {

})
@Entity
@Table(name = "significantpointinairspace_pt", schema = "navaids_points")
public class SignificantPointInAirspacePropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "significantpointinairspace_pt_seq")
    @SequenceGenerator(name = "significantpointinairspace_pt_seq", sequenceName = "significantpointinairspace_pt_seq", allocationSize = 1)
