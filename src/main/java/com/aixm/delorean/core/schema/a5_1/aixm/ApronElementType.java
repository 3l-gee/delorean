...
@Entity
@Table(name = "apronelement", schema = "apron")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "apronelement_timeslice", joinColumns = {
        @JoinColumn(name = "apronelement_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "apronelement_tsp_id")
    })
