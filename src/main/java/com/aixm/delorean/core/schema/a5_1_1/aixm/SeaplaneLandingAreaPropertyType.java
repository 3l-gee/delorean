...
@XmlType(name = "SeaplaneLandingAreaPropertyType", propOrder = {
...
public class SeaplaneLandingAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seaplanelandingarea_pt_seq")
    @SequenceGenerator(name = "seaplanelandingarea_pt_seq", sequenceName = "seaplanelandingarea_pt_seq", allocationSize = 1)
