...
@Entity
@Table(name = "runway_direction_light_system_slice", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstract_runway_direction_light_system_extension_id", referencedColumnName = "id")
