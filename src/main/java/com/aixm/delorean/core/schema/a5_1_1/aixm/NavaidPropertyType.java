...
@XmlType(name = "NavaidPropertyType", propOrder = {

})
@Entity
@Table(name = "navaid_pt", schema = "navaids_points")
public class NavaidPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "navaid_pt_seq")
    @SequenceGenerator(name = "navaid_pt_seq", sequenceName = "navaid_pt_seq", allocationSize = 1)
