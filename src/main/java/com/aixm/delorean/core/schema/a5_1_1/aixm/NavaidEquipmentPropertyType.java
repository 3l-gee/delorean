...
@XmlType(name = "NavaidEquipmentPropertyType", propOrder = {

})
@Entity
@Table(name = "navaidequipment_pt", schema = "navaids_points")
public class NavaidEquipmentPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "navaidequipment_pt_seq")
    @SequenceGenerator(name = "navaidequipment_pt_seq", sequenceName = "navaidequipment_pt_seq", allocationSize = 1)
