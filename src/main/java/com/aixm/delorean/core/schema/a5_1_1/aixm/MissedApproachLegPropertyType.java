...
@XmlType(name = "MissedApproachLegPropertyType", propOrder = {
...
public class MissedApproachLegPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "missedapproachleg_pt_seq")
    @SequenceGenerator(name = "missedapproachleg_pt_seq", sequenceName = "missedapproachleg_pt_seq", allocationSize = 1)
