...
@Entity
@Table(name = "taxi_holding_position_light_system_time_slice_type")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    public static class Extension {
        ...
        @Column(name = "aixm:_abstract_taxi_holding_position_light_system_extension")
