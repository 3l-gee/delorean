...
public class StandardLevelSectorTimeSlicePropertyType {
    ...
    @JoinColumn(name = "standardlevelsectortimeslice_id", referencedColumnName = "id")
    protected StandardLevelSectorTimeSliceType standardLevelSectorTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardlevelsector_tsp_seq")
    @SequenceGenerator(name = "standardlevelsector_tsp_seq", sequenceName = "standardlevelsector_tsp_seq", allocationSize = 1)
