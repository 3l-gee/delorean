    ...
    extends AbstractAIXMObjectType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "videomap_value", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "videomap_nilreason", length = 255, nullable = true, unique = false))
    })
    ...
    @JoinTable(name = "surveillancegroundstation_annotation", joinColumns = {
        @JoinColumn(name = "surveillancegroundstation_id")
    }, inverseJoinColumns = {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractsurveillancegroundstationextension_id", referencedColumnName = "id")
