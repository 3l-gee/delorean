...
public class TaxiHoldingPositionMarkingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "taxiholdingpositionmarkingtimeslice_id", referencedColumnName = "id")
    protected TaxiHoldingPositionMarkingTimeSliceType taxiHoldingPositionMarkingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiholdingpositionmarking_tsp_seq")
    @SequenceGenerator(name = "taxiholdingpositionmarking_tsp_seq", sequenceName = "taxiholdingpositionmarking_tsp_seq", allocationSize = 1)
