...
@XmlType(name = "SearchRescueServicePropertyType", propOrder = {
...
public class SearchRescueServicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "searchrescueservice_pt_seq")
    @SequenceGenerator(name = "searchrescueservice_pt_seq", sequenceName = "searchrescueservice_pt_seq", allocationSize = 1)
