...
@XmlType(name = "ApronElementPropertyType", propOrder = {
...
public class ApronElementPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "apronelement_pt_seq")
    @SequenceGenerator(name = "apronelement_pt_seq", sequenceName = "apronelement_pt_seq", allocationSize = 1)
