...
@XmlType(name = "WorkAreaPropertyType", propOrder = {
...
public class WorkAreaPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "workarea_pt_seq")
    @SequenceGenerator(name = "workarea_pt_seq", sequenceName = "workarea_pt_seq", allocationSize = 1)
