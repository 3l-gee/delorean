...
@Entity
@Table(name = "specialnavigationstation_tsp", schema = "navaids_points")
public class SpecialNavigationStationTimeSlicePropertyType {
    ...
    @JoinColumn(name = "specialnavigationstationtimeslice_id", referencedColumnName = "id")
    protected SpecialNavigationStationTimeSliceType specialNavigationStationTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "specialnavigationstation_tsp_seq")
    @SequenceGenerator(name = "specialnavigationstation_tsp_seq", sequenceName = "specialnavigationstation_tsp_seq", allocationSize = 1)
