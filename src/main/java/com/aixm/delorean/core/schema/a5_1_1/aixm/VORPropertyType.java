...
@XmlType(name = "VORPropertyType", propOrder = {

})
@Entity
@Table(name = "vor_pt", schema = "navaids_points")
public class VORPropertyType {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "vor_pt_seq")
    @SequenceGenerator(name = "vor_pt_seq", sequenceName = "vor_pt_seq", allocationSize = 1)
