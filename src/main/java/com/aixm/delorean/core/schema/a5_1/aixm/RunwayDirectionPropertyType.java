...
public class RunwayDirectionPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwaydirection_pt_seq")
    @SequenceGenerator(name = "runwaydirection_pt_seq", sequenceName = "runwaydirection_pt_seq", allocationSize = 1)
