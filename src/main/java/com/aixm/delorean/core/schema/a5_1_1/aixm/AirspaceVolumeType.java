...
@Entity
@Table(name = "airspacevolumetype", schema = "public")
    ...
    extends AbstractAIXMObjectType
{
    ...
    @JoinTable(name = "airspacevolumepropertygroup_annotation", joinColumns = {
        @JoinColumn(name = "airspacevolumepropertygroup_id")
    }, inverseJoinColumns = {
