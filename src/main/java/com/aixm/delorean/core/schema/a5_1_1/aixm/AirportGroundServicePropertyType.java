...
@XmlType(name = "AirportGroundServicePropertyType", propOrder = {
...
public class AirportGroundServicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportgroundservice_pt_seq")
    @SequenceGenerator(name = "airportgroundservice_pt_seq", sequenceName = "airportgroundservice_pt_seq", allocationSize = 1)
