...
@XmlType(name = "DesignatedPointPropertyType", propOrder = {
...
public class DesignatedPointPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "designatedpoint_pt_seq")
    @SequenceGenerator(name = "designatedpoint_pt_seq", sequenceName = "designatedpoint_pt_seq", allocationSize = 1)
