...
@Entity
@Table(name = "touch_down_lift_off_contamination", schema = "public")
    ...
    extends AbstractSurfaceContaminationType
{
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstract_touch_down_lift_off_contamination_extension_id", referencedColumnName = "id")
