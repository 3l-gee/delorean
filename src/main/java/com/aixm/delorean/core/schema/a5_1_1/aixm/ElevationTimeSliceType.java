...
@Entity
@Table(name = "elevation_time_slice_type", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angle_nominal_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angle_nominal_nilreason"))
    })
    protected ValAngleType angleNominal;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angle_minimum_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angle_minimum_nilreason"))
    })
    protected ValAngleType angleMinimum;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angle_span_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angle_span_nilreason"))
    })
    protected ValAngleType angleSpan;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "angle_accuracy_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "angle_accuracy_nilreason"))
    })
