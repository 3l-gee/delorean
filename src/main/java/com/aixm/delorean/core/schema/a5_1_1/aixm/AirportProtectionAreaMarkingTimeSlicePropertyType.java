...
@Entity
@Table(name = "airport_protection_area_marking_slice_property", schema = "public")
public class AirportProtectionAreaMarkingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airport_protection_area_marking_slice_id", referencedColumnName = "id")
