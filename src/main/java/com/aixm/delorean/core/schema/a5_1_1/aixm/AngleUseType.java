...
@Entity
@Table(name = "angle_use_type", schema = "public")
    ...
    extends AbstractAIXMObjectType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "along_course_guidance_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "along_course_guidance_nilreason"))
    })
