    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "flightrestrictiontype_timeslice", joinColumns = {
        @JoinColumn(name = "flightrestrictiontype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "flightrestrictiontimeslicepropertytype_id")
    })
