...
public class AirportHeliportCollocationTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airportheliportcollocationtimeslice_id", referencedColumnName = "id")
    protected AirportHeliportCollocationTimeSliceType airportHeliportCollocationTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportheliportcollocation_tsp_seq")
    @SequenceGenerator(name = "airportheliportcollocation_tsp_seq", sequenceName = "airportheliportcollocation_tsp_seq", allocationSize = 1)
