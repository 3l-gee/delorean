...
public class NonMovementAreaTimeSlicePropertyType {
    ...
    @JoinColumn(name = "nonmovementareatimeslice_id", referencedColumnName = "id")
    protected NonMovementAreaTimeSliceType nonMovementAreaTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "nonmovementarea_tsp_seq")
    @SequenceGenerator(name = "nonmovementarea_tsp_seq", sequenceName = "nonmovementarea_tsp_seq", allocationSize = 1)
