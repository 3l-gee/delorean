...
@XmlType(name = "SeaplaneRampSitePropertyType", propOrder = {
...
public class SeaplaneRampSitePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seaplanerampsite_pt_seq")
    @SequenceGenerator(name = "seaplanerampsite_pt_seq", sequenceName = "seaplanerampsite_pt_seq", allocationSize = 1)
