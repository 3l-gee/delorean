...
@Entity
@Table(name = "touchdownliftofflightsystem_ts", schema = "lighting")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "touchdownliftofflightsystem_ts_element_", joinColumns = {
        @JoinColumn(name = "touchdownliftofflightsystem_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "touchdownliftofflightsystem_ts_availability", joinColumns = {
        @JoinColumn(name = "touchdownliftofflightsystem_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "touchdownliftofflightsystem_ts_annotation", joinColumns = {
        @JoinColumn(name = "touchdownliftofflightsystem_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinColumn(name = "lightedtouchdownliftoff_id", referencedColumnName = "id")
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstracttouchdownliftofflightsystemextension_id", referencedColumnName = "id")
