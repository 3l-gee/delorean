...
public class TaxiHoldingPositionTimeSlicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiholdingposition_tsp_seq")
    @SequenceGenerator(name = "taxiholdingposition_tsp_seq", sequenceName = "taxiholdingposition_tsp_seq", allocationSize = 1)
