...
@Entity
@Table(name = "runwaytype", schema = "runway")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "runwaytype_timeslice", joinColumns = {
        @JoinColumn(name = "runwaytype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "runwaytimeslicepropertytype_id")
    })
