...
@Entity
@Table(name = "vor_ts", schema = "navaids_points")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "vor_ts_authority", joinColumns = {
        @JoinColumn(name = "vor_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "vor_ts_monitoring", joinColumns = {
        @JoinColumn(name = "vor_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "vor_ts_availability", joinColumns = {
        @JoinColumn(name = "vor_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "vor_ts_annotation", joinColumns = {
        @JoinColumn(name = "vor_ts_id")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "zerobearingdirection_value", length = 255, nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "zerobearingdirection_nilreason", length = 255, nullable = true, unique = false))
    })
