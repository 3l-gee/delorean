...
@Entity
@Table(name = "tacan_tsp", schema = "navaids_points")
public class TACANTimeSlicePropertyType {
    ...
    @JoinColumn(name = "tacantimeslice_id", referencedColumnName = "id")
    protected TACANTimeSliceType tacanTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "tacan_tsp_seq")
    @SequenceGenerator(name = "tacan_tsp_seq", sequenceName = "tacan_tsp_seq", allocationSize = 1)
