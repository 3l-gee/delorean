    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "safealtitudeareatype_timeslice", joinColumns = {
        @JoinColumn(name = "safealtitudeareatype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "safealtitudeareatimeslicepropertytype_id")
    })
