...
public class AirportHotSpotTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airporthotspottimeslice_id", referencedColumnName = "id")
    protected AirportHotSpotTimeSliceType airportHotSpotTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airporthotspot_tsp_seq")
    @SequenceGenerator(name = "airporthotspot_tsp_seq", sequenceName = "airporthotspot_tsp_seq", allocationSize = 1)
