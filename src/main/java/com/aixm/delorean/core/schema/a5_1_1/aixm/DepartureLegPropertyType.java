...
@XmlType(name = "DepartureLegPropertyType", propOrder = {
...
public class DepartureLegPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "departureleg_pt_seq")
    @SequenceGenerator(name = "departureleg_pt_seq", sequenceName = "departureleg_pt_seq", allocationSize = 1)
