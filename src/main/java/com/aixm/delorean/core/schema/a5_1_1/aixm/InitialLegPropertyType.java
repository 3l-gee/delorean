...
@XmlType(name = "InitialLegPropertyType", propOrder = {
...
public class InitialLegPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "initialleg_pt_seq")
    @SequenceGenerator(name = "initialleg_pt_seq", sequenceName = "initialleg_pt_seq", allocationSize = 1)
