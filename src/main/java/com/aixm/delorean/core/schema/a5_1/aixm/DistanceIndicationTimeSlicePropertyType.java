...
public class DistanceIndicationTimeSlicePropertyType {
    ...
    @JoinColumn(name = "distanceindicationtimeslice_id", referencedColumnName = "id")
    protected DistanceIndicationTimeSliceType distanceIndicationTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "distanceindication_tsp_seq")
    @SequenceGenerator(name = "distanceindication_tsp_seq", sequenceName = "distanceindication_tsp_seq", allocationSize = 1)
