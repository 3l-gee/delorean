...
@Entity
@Table(name = "touch_down_lift_off_light_system_slice_property", schema = "public")
public class TouchDownLiftOffLightSystemTimeSlicePropertyType {
    ...
    @JoinColumn(name = "touch_down_lift_off_light_system_slice_id", referencedColumnName = "id")
