...
public class TouchDownLiftOffSafeAreaTimeSlicePropertyType {
    ...
    @JoinColumn(name = "touchdownliftoffsafeareatimeslice_id", referencedColumnName = "id")
    protected TouchDownLiftOffSafeAreaTimeSliceType touchDownLiftOffSafeAreaTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "touchdownliftoffsafearea_tsp_seq")
    @SequenceGenerator(name = "touchdownliftoffsafearea_tsp_seq", sequenceName = "touchdownliftoffsafearea_tsp_seq", allocationSize = 1)
