...
public class ProcedureDMETimeSlicePropertyType {
    ...
    @JoinColumn(name = "proceduredmetimeslice_id", referencedColumnName = "id")
    protected ProcedureDMETimeSliceType procedureDMETimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "proceduredme_tsp_seq")
    @SequenceGenerator(name = "proceduredme_tsp_seq", sequenceName = "proceduredme_tsp_seq", allocationSize = 1)
