...
@XmlType(name = "StandardLevelColumnPropertyType", propOrder = {
...
public class StandardLevelColumnPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardlevelcolumn_pt_seq")
    @SequenceGenerator(name = "standardlevelcolumn_pt_seq", sequenceName = "standardlevelcolumn_pt_seq", allocationSize = 1)
