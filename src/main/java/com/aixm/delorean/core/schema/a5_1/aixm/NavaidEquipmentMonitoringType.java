    ...
    extends AbstractPropertiesWithScheduleType
{
    ...
    @JoinTable(name = "navaidequipmentmonitoring_timeinterval", joinColumns = {
        @JoinColumn(name = "navaidequipmentmonitoring_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "navaidequipmentmonitoring_annotation", joinColumns = {
        @JoinColumn(name = "navaidequipmentmonitoring_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "navaidequipmentmonitoring_specialdateauthority", joinColumns = {
        @JoinColumn(name = "navaidequipmentmonitoring_id")
    }, inverseJoinColumns = {
    ...
    @AttributeOverrides({
        ...
        @AttributeOverride(name = "nilReason", column = @Column(name = "monitored_nilreason", length = 255, nullable = true, unique = false))
    })
    protected CodeYesNoType monitored;
    @Transient
     ...
     *     
     */
    public CodeYesNoType getMonitored() {
        return monitored;
    }
     ...
     *     
     */
    public void setMonitored(CodeYesNoType value) {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractnavaidequipmentmonitoringextension_id", referencedColumnName = "id")
