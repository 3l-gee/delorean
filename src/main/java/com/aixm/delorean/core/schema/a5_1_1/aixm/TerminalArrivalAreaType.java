...
@Entity
@Table(name = "terminalarrivalareatype", schema = "terminal")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "terminalarrivalareatype_timeslice", joinColumns = {
        @JoinColumn(name = "terminalarrivalareatype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "terminalarrivalareatimeslicepropertytype_id")
    })
