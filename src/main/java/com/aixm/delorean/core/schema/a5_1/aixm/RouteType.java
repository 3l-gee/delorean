...
@Entity
@Table(name = "routetype", schema = "en_route")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "routetype_timeslice", joinColumns = {
        @JoinColumn(name = "routetype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "routetimeslicepropertytype_id")
    })
