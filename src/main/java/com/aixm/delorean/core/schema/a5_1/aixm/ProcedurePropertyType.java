...
public class ProcedurePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "procedure_pt_seq")
    @SequenceGenerator(name = "procedure_pt_seq", sequenceName = "procedure_pt_seq", allocationSize = 1)
