...
@XmlType(name = "GroundTrafficControlServicePropertyType", propOrder = {
...
public class GroundTrafficControlServicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "groundtrafficcontrolservice_pt_seq")
    @SequenceGenerator(name = "groundtrafficcontrolservice_pt_seq", sequenceName = "groundtrafficcontrolservice_pt_seq", allocationSize = 1)
