...
@XmlType(name = "AuthorityForAirspacePropertyType", propOrder = {
...
public class AuthorityForAirspacePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "authorityforairspace_pt_seq")
    @SequenceGenerator(name = "authorityforairspace_pt_seq", sequenceName = "authorityforairspace_pt_seq", allocationSize = 1)
