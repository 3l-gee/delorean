...
@Entity
@Table(name = "runwaymarking", schema = "markings")
    ...
    extends AbstractMarkingType
{
    ...
    @JoinTable(name = "runwaymarking_timeslice", joinColumns = {
        @JoinColumn(name = "runwaymarking_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "runwaymarking_tsp_id")
    })
