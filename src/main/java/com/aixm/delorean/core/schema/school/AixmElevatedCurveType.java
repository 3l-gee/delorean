...
/**
 * <p>Java class for AixmElevatedCurveType complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="AixmElevatedCurveType">
 *   <complexContent>
 *     <extension base="{}AixmCurveType">
 *       <sequence>
...
@XmlType(name = "AixmElevatedCurveType", propOrder = {
    "elevation",
    "geoidUndulation",
    "verticalDatum",
    "verticalAccuracy",
...
public class AixmElevatedCurveType
    extends AixmCurveType
{

    @XmlElementRef(name = "elevation", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> elevation;
    @XmlElementRef(name = "geoidUndulation", type = JAXBElement.class, required = false)
    protected JAXBElement<Long> geoidUndulation;
    @XmlElementRef(name = "verticalDatum", type = JAXBElement.class, required = false)
    ...
    protected List<AixmElevatedCurveType.Extension> extension;
     ...
     *     
     */
    public JAXBElement<Long> getElevation() {
        return elevation;
    }
     ...
     *     
     */
    public void setElevation(JAXBElement<Long> value) {
     ...
     *     
     */
    public JAXBElement<Long> getGeoidUndulation() {
     ...
     *     
     */
    public JAXBElement<String> getVerticalDatum() {
     ...
     *     
     */
    public void setVerticalDatum(JAXBElement<String> value) {
     ...
     *     
     */
    public JAXBElement<Long> getVerticalAccuracy() {
     ...
     * {@link AixmElevatedCurveType.Extension }
     * </p>
     * 
     * 
     * @return
     ...
     */
    public List<AixmElevatedCurveType.Extension> getExtension() {
        if (extension == null) {
