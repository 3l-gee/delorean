...
@Entity
@Table(name = "guidanceline", schema = "taxiway")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "guidanceline_timeslice", joinColumns = {
        @JoinColumn(name = "guidanceline_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "guidanceline_tsp_id")
    })
