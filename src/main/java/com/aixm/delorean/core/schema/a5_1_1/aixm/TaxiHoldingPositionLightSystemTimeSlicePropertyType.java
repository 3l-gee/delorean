...
@Entity
@Table(name = "taxi_holding_position_light_system_slice_property", schema = "public")
public class TaxiHoldingPositionLightSystemTimeSlicePropertyType {
    ...
    @JoinColumn(name = "taxi_holding_position_light_system_slice_id", referencedColumnName = "id")
