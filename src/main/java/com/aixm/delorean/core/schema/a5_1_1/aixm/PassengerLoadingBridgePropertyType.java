...
@XmlType(name = "PassengerLoadingBridgePropertyType", propOrder = {
...
public class PassengerLoadingBridgePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "passengerloadingbridge_pt_seq")
    @SequenceGenerator(name = "passengerloadingbridge_pt_seq", sequenceName = "passengerloadingbridge_pt_seq", allocationSize = 1)
