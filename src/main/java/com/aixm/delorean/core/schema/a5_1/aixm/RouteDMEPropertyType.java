...
@XmlType(name = "RouteDMEPropertyType", propOrder = {
...
public class RouteDMEPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "routedme_pt_seq")
    @SequenceGenerator(name = "routedme_pt_seq", sequenceName = "routedme_pt_seq", allocationSize = 1)
