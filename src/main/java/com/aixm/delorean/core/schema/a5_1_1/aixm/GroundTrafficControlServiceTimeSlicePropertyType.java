...
public class GroundTrafficControlServiceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "groundtrafficcontrolservicetimeslice_id", referencedColumnName = "id")
    protected GroundTrafficControlServiceTimeSliceType groundTrafficControlServiceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "groundtrafficcontrolservice_tsp_seq")
    @SequenceGenerator(name = "groundtrafficcontrolservice_tsp_seq", sequenceName = "groundtrafficcontrolservice_tsp_seq", allocationSize = 1)
