...
@Entity
@Table(name = "routesegment_tsp", schema = "routes")
public class RouteSegmentTimeSlicePropertyType {
    ...
    @JoinColumn(name = "routesegmenttimeslice_id", referencedColumnName = "id")
    protected RouteSegmentTimeSliceType routeSegmentTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "routesegment_tsp_seq")
    @SequenceGenerator(name = "routesegment_tsp_seq", sequenceName = "routesegment_tsp_seq", allocationSize = 1)
