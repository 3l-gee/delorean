...
public class UnplannedHoldingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "unplannedholdingtimeslice_id", referencedColumnName = "id")
    protected UnplannedHoldingTimeSliceType unplannedHoldingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "unplannedholding_tsp_seq")
    @SequenceGenerator(name = "unplannedholding_tsp_seq", sequenceName = "unplannedholding_tsp_seq", allocationSize = 1)
