...
@Entity
@Table(name = "airportheliportcollocationtimeslicetype", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinColumn(name = "hostairport_id", referencedColumnName = "id")
    ...
    @JoinTable(name = "airportheliportcollocationpropertygroup_annotation", joinColumns = {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractairportheliportcollocationextension_id", referencedColumnName = "id")
