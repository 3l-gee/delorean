...
public class RunwayMarkingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwaymarkingtimeslice_id", referencedColumnName = "id")
    protected RunwayMarkingTimeSliceType runwayMarkingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwaymarking_tsp_seq")
    @SequenceGenerator(name = "runwaymarking_tsp_seq", sequenceName = "runwaymarking_tsp_seq", allocationSize = 1)
