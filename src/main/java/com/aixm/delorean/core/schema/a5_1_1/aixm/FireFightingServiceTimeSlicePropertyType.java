...
public class FireFightingServiceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "firefightingservicetimeslice_id", referencedColumnName = "id")
    protected FireFightingServiceTimeSliceType fireFightingServiceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "firefightingservice_tsp_seq")
    @SequenceGenerator(name = "firefightingservice_tsp_seq", sequenceName = "firefightingservice_tsp_seq", allocationSize = 1)
