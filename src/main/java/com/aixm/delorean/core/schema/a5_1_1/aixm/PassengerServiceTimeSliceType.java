...
@Entity
@Table(name = "passengerservicetimeslicetype", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "passengerservicetimeslicetype_call-sign", joinColumns = {
        @JoinColumn(name = "passengerservicetimeslicetype_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservicetimeslicetype_radiocommunication", joinColumns = {
        @JoinColumn(name = "passengerservicetimeslicetype_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservicetimeslicetype_groundcommunication", joinColumns = {
        @JoinColumn(name = "passengerservicetimeslicetype_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservicetimeslicetype_availability", joinColumns = {
        @JoinColumn(name = "passengerservicetimeslicetype_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservicetimeslicetype_annotation", joinColumns = {
        @JoinColumn(name = "passengerservicetimeslicetype_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "passengerservicetimeslicetype_airportheliport", joinColumns = {
        @JoinColumn(name = "passengerservicetimeslicetype_id")
    }, inverseJoinColumns = {
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractpassengerserviceextension_id", referencedColumnName = "id")
