...
/**
 * <p>Java class for implementationAixmCurve complex type</p>.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.</p>
 * 
 * <pre>{@code
 * <complexType name="implementationAixmCurve">
 *   <complexContent>
...
@XmlType(name = "implementationAixmCurve", propOrder = {
    "aixmCurve",
    "name",
    "id"
})
@Entity
@Table(name = "impl_aixm_curve")
public class ImplementationAixmCurve {
    ...
    public boolean isSetAixmCurve() {
        return (this.aixmCurve!= null);
    }
