...
@Entity
@Table(name = "airportheliportresponsibilityorganisationpropertytype", schema = "public")
    ...
    extends AbstractAIXMPropertyType
{
    ...
    @JoinColumn(name = "airportheliportresponsibilityorganisation_id", referencedColumnName = "id")
