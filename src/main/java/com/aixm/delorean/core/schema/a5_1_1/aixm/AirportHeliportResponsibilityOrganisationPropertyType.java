...
@Entity
@Table(name = "airport_heliport_responsibility_organisation_property", schema = "public")
    ...
    extends AbstractAIXMPropertyType
{
    ...
    @JoinColumn(name = "airport_heliport_responsibility_organisation_id", referencedColumnName = "id")
