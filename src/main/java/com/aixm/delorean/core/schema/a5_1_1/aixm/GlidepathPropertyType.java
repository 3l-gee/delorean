...
@XmlType(name = "GlidepathPropertyType", propOrder = {
...
public class GlidepathPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "glidepath_pt_seq")
    @SequenceGenerator(name = "glidepath_pt_seq", sequenceName = "glidepath_pt_seq", allocationSize = 1)
