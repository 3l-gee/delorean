...
public class OrganisationAuthorityTimeSlicePropertyType {
    ...
    @JoinColumn(name = "organisationauthoritytimeslice_id", referencedColumnName = "id")
    protected OrganisationAuthorityTimeSliceType organisationAuthorityTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "organisationauthority_tsp_seq")
    @SequenceGenerator(name = "organisationauthority_tsp_seq", sequenceName = "organisationauthority_tsp_seq", allocationSize = 1)
