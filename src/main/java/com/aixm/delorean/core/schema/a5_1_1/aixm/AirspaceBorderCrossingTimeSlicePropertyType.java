...
public class AirspaceBorderCrossingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airspacebordercrossingtimeslice_id", referencedColumnName = "id")
    protected AirspaceBorderCrossingTimeSliceType airspaceBorderCrossingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airspacebordercrossing_tsp_seq")
    @SequenceGenerator(name = "airspacebordercrossing_tsp_seq", sequenceName = "airspacebordercrossing_tsp_seq", allocationSize = 1)
