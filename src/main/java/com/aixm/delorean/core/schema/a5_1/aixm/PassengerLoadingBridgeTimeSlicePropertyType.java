...
public class PassengerLoadingBridgeTimeSlicePropertyType {
    ...
    @JoinColumn(name = "passengerloadingbridgetimeslice_id", referencedColumnName = "id")
    protected PassengerLoadingBridgeTimeSliceType passengerLoadingBridgeTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "passengerloadingbridge_tsp_seq")
    @SequenceGenerator(name = "passengerloadingbridge_tsp_seq", sequenceName = "passengerloadingbridge_tsp_seq", allocationSize = 1)
