...
public class RunwayBlastPadTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwayblastpadtimeslice_id", referencedColumnName = "id")
    protected RunwayBlastPadTimeSliceType runwayBlastPadTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayblastpad_tsp_seq")
    @SequenceGenerator(name = "runwayblastpad_tsp_seq", sequenceName = "runwayblastpad_tsp_seq", allocationSize = 1)
