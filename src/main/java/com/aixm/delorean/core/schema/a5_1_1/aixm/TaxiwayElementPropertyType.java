...
@XmlType(name = "TaxiwayElementPropertyType", propOrder = {
...
public class TaxiwayElementPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "taxiwayelement_pt_seq")
    @SequenceGenerator(name = "taxiwayelement_pt_seq", sequenceName = "taxiwayelement_pt_seq", allocationSize = 1)
