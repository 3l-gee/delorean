...
@Entity
@Table(name = "radiocommunicationoperationalstatuspropertytype", schema = "public")
    ...
    extends AbstractAIXMPropertyType
{
    ...
    @JoinColumn(name = "radiocommunicationoperationalstatus_id", referencedColumnName = "id")
