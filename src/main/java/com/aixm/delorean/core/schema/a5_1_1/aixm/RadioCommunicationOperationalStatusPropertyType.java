...
@Entity
@Table(name = "radio_communication_operational_status_property", schema = "public")
    ...
    extends AbstractAIXMPropertyType
{
    ...
    @JoinColumn(name = "radio_communication_operational_status_id", referencedColumnName = "id")
