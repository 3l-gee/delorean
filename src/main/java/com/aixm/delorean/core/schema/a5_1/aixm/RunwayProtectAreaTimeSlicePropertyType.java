...
public class RunwayProtectAreaTimeSlicePropertyType {
    ...
    @JoinColumn(name = "runwayprotectareatimeslice_id", referencedColumnName = "id")
    protected RunwayProtectAreaTimeSliceType runwayProtectAreaTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwayprotectarea_tsp_seq")
    @SequenceGenerator(name = "runwayprotectarea_tsp_seq", sequenceName = "runwayprotectarea_tsp_seq", allocationSize = 1)
