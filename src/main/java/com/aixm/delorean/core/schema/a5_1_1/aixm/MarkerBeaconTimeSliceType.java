...
@Entity
@Table(name = "marker_beacon_time_slice_type", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "axis_bearing_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "axis_bearing_nilreason"))
    })
    protected ValBearingType axisBearing;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "aural_morse_code_value")),
        @AttributeOverride(name = "nilReason", column = @Column(name = "aural_morse_code_nilreason"))
    })
