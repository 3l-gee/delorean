    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "markerbeacon_ts_authority", joinColumns = {
        @JoinColumn(name = "markerbeacon_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "markerbeacon_ts_monitoring", joinColumns = {
        @JoinColumn(name = "markerbeacon_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "markerbeacon_ts_availability", joinColumns = {
        @JoinColumn(name = "markerbeacon_ts_id")
    }, inverseJoinColumns = {
    ...
    @JoinTable(name = "markerbeacon_ts_annotation", joinColumns = {
        @JoinColumn(name = "markerbeacon_ts_id")
    }, inverseJoinColumns = {
    ...
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "axisbearing_value", length = 255, columnDefinition = "DECIMAL", nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "axisbearing_nilreason", length = 255, nullable = true, unique = false))
    })
    protected ValBearingType axisBearing;
    @XmlElement(nillable = true)
    @Embedded
    @AttributeOverrides({
        @AttributeOverride(name = "value", column = @Column(name = "auralmorsecode_value", length = 255, columnDefinition = "TEXT", nullable = true, unique = false)),
        @AttributeOverride(name = "nilReason", column = @Column(name = "auralmorsecode_nilreason", length = 255, nullable = true, unique = false))
    })
    ...
    public static class Extension {
        ...
        @JoinColumn(name = "abstractmarkerbeaconextension_id", referencedColumnName = "id")
