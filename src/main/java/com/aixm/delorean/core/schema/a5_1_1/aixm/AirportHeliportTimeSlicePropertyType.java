...
public class AirportHeliportTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airportheliporttimeslice_id", referencedColumnName = "id")
    protected AirportHeliportTimeSliceType airportHeliportTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportheliport_tsp_seq")
    @SequenceGenerator(name = "airportheliport_tsp_seq", sequenceName = "airportheliport_tsp_seq", allocationSize = 1)
