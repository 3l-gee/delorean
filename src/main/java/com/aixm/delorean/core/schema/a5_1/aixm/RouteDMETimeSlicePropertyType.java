...
public class RouteDMETimeSlicePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "routedme_tsp_seq")
    @SequenceGenerator(name = "routedme_tsp_seq", sequenceName = "routedme_tsp_seq", allocationSize = 1)
