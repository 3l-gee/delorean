...
public class ApronElementTimeSlicePropertyType {
    ...
    @JoinColumn(name = "apronelementtimeslice_id", referencedColumnName = "id")
    protected ApronElementTimeSliceType apronElementTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "apronelement_tsp_seq")
    @SequenceGenerator(name = "apronelement_tsp_seq", sequenceName = "apronelement_tsp_seq", allocationSize = 1)
