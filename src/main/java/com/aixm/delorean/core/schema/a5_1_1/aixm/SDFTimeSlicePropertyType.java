...
public class SDFTimeSlicePropertyType {
    ...
    @JoinColumn(name = "sdftimeslice_id", referencedColumnName = "id")
    protected SDFTimeSliceType sdfTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sdf_tsp_seq")
    @SequenceGenerator(name = "sdf_tsp_seq", sequenceName = "sdf_tsp_seq", allocationSize = 1)
