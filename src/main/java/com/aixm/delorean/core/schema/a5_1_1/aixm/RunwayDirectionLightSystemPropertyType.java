...
@XmlType(name = "RunwayDirectionLightSystemPropertyType", propOrder = {
...
public class RunwayDirectionLightSystemPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runwaydirectionlightsystem_pt_seq")
    @SequenceGenerator(name = "runwaydirectionlightsystem_pt_seq", sequenceName = "runwaydirectionlightsystem_pt_seq", allocationSize = 1)
