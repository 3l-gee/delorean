...
public class GlidepathTimeSlicePropertyType {
    ...
    @JoinColumn(name = "glidepathtimeslice_id", referencedColumnName = "id")
    protected GlidepathTimeSliceType glidepathTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "glidepath_tsp_seq")
    @SequenceGenerator(name = "glidepath_tsp_seq", sequenceName = "glidepath_tsp_seq", allocationSize = 1)
