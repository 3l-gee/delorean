...
@Entity
@Table(name = "designatedpointtimeslicetype", schema = "public")
    ...
    extends AbstractAIXMTimeSliceType
{
    ...
    @JoinTable(name = "designatedpointpropertygroup_annotation", joinColumns = {
        @JoinColumn(name = "designatedpointpropertygroup_id")
    }, inverseJoinColumns = {
