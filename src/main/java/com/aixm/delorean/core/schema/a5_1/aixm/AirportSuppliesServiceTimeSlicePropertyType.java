...
public class AirportSuppliesServiceTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airportsuppliesservicetimeslice_id", referencedColumnName = "id")
    protected AirportSuppliesServiceTimeSliceType airportSuppliesServiceTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportsuppliesservice_tsp_seq")
    @SequenceGenerator(name = "airportsuppliesservice_tsp_seq", sequenceName = "airportsuppliesservice_tsp_seq", allocationSize = 1)
