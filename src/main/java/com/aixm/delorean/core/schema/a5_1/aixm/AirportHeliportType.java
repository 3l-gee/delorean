...
@Entity
@Table(name = "airportheliporttype", schema = "airport_heliport")
    ...
    extends AbstractAIXMFeatureType
{
    ...
    @JoinTable(name = "airportheliporttype_timeslice", joinColumns = {
        @JoinColumn(name = "airportheliporttype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "airportheliporttimeslicepropertytype_id")
    })
