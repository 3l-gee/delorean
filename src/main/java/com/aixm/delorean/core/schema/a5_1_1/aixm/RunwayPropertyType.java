...
@XmlType(name = "RunwayPropertyType", propOrder = {
...
public class RunwayPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "runway_pt_seq")
    @SequenceGenerator(name = "runway_pt_seq", sequenceName = "runway_pt_seq", allocationSize = 1)
