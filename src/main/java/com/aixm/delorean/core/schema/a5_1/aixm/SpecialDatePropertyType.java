...
@XmlType(name = "SpecialDatePropertyType", propOrder = {
...
public class SpecialDatePropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "specialdate_pt_seq")
    @SequenceGenerator(name = "specialdate_pt_seq", sequenceName = "specialdate_pt_seq", allocationSize = 1)
