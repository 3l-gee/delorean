...
@XmlType(name = "ProcedureDMEPropertyType", propOrder = {
...
public class ProcedureDMEPropertyType {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "proceduredme_pt_seq")
    @SequenceGenerator(name = "proceduredme_pt_seq", sequenceName = "proceduredme_pt_seq", allocationSize = 1)
