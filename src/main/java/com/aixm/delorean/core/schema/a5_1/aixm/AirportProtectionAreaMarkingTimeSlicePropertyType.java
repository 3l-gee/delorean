...
public class AirportProtectionAreaMarkingTimeSlicePropertyType {
    ...
    @JoinColumn(name = "airportprotectionareamarkingtimeslice_id", referencedColumnName = "id")
    protected AirportProtectionAreaMarkingTimeSliceType airportProtectionAreaMarkingTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "airportprotectionareamarking_tsp_seq")
    @SequenceGenerator(name = "airportprotectionareamarking_tsp_seq", sequenceName = "airportprotectionareamarking_tsp_seq", allocationSize = 1)
