...
public class StandardInstrumentDepartureTimeSlicePropertyType {
    ...
    @JoinColumn(name = "standardinstrumentdeparturetimeslice_id", referencedColumnName = "id")
    protected StandardInstrumentDepartureTimeSliceType standardInstrumentDepartureTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "standardinstrumentdeparture_tsp_seq")
    @SequenceGenerator(name = "standardinstrumentdeparture_tsp_seq", sequenceName = "standardinstrumentdeparture_tsp_seq", allocationSize = 1)
