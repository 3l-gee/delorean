...
public class DepartureLegTimeSlicePropertyType {
    ...
    @JoinColumn(name = "departurelegtimeslice_id", referencedColumnName = "id")
    protected DepartureLegTimeSliceType departureLegTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "departureleg_tsp_seq")
    @SequenceGenerator(name = "departureleg_tsp_seq", sequenceName = "departureleg_tsp_seq", allocationSize = 1)
