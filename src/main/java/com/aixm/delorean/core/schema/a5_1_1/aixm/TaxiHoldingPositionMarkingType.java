...
@Entity
@Table(name = "taxiholdingpositionmarkingtype", schema = "markings")
    ...
    extends AbstractMarkingType
{
    ...
    @JoinTable(name = "taxiholdingpositionmarkingtype_timeslice", joinColumns = {
        @JoinColumn(name = "taxiholdingpositionmarkingtype_id")
    }, inverseJoinColumns = {
        @JoinColumn(name = "taxiholdingpositionmarkingtimeslicepropertytype_id")
    })
