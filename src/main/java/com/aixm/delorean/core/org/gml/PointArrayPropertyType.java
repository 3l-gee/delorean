...
public class PointArrayPropertyType {
    ...
    protected List<JAXBElement<? extends com.aixm.delorean.core.org.gml.PointType>> point;
     ...
     */
    public List<JAXBElement<? extends com.aixm.delorean.core.org.gml.PointType>> getPoint() {
        if (point == null) {
            point = new ArrayList<>();
        }
        return this.point;
