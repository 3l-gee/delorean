...
@Entity
@Table(name = "ndb_tsp", schema = "navaids_points")
public class NDBTimeSlicePropertyType {
    ...
    @JoinColumn(name = "ndbtimeslice_id", referencedColumnName = "id")
    protected NDBTimeSliceType ndbTimeSlice;
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ndb_tsp_seq")
    @SequenceGenerator(name = "ndb_tsp_seq", sequenceName = "ndb_tsp_seq", allocationSize = 1)
