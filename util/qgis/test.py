...
<qgis saveDateTime="2025-05-24T10:35:00" projectname="" version="3.34.8-Prizren" saveUser="rapha" saveUserFull="Raphael Gerth">
  <homePath path=""/>
  <title></title>
  ...
  <elevation-shading-renderer edl-is-active="1" light-azimuth="315" hillshading-is-multidirectional="0" edl-distance="0.5" hillshading-is-active="0" is-active="0" edl-distance-unit="0" hillshading-z-factor="1" light-altitude="45" combined-method="0" edl-strength="1000"/>
  <layer-tree-group>
    <customproperties>
      <Option/>
    </customproperties>
  ...
  <mapcanvas name="theMapCanvas" annotationsVisible="1">
    <units>degrees</units>
    <extent>
      <xmin>4.14361879081629869</xmin>
      <ymin>44.86014909046199506</ymin>
      <xmax>11.56188343446944344</xmax>
      <ymax>47.68331086563140531</ymax>
    </extent>
    <rotation>0</rotation>
    <destinationsrs>
      <spatialrefsys nativeFormat="Wkt">
  ...
  <mapViewDocks/>
  <main-annotation-layer legendPlaceholderImage="" styleCategories="AllStyleCategories" minScale="0" maxScale="0" hasScaleBasedVisibilityFlag="0" autoRefreshMode="Disabled" refreshOnNotifyEnabled="0" refreshOnNotifyMessage="" type="annotation" autoRefreshTime="0">
    <id>Annotations_8a13d8ef_7f9c_45de_9f5a_bdcb31aa9c43</id>
  ...
  <ProjectStyleSettings RandomizeDefaultSymbolColor="1" projectStyleId="attachment:///drNMIP_styles.db" DefaultSymbolOpacity="1">
    <databases/>
  ...
  <ProjectGpsSettings autoCommitFeatures="0" autoAddTrackVertices="0" destinationLayer="" destinationFollowsActiveLayer="1">
    <timeStampFields/>
  </ProjectGpsSettings>
</qgis>
"""

# Step 1: Compress text into a ZIP archive stored in memory
zip_bytes_io = io.BytesIO()
with zipfile.ZipFile(zip_bytes_io, mode="w", compression=zipfile.ZIP_DEFLATED) as zf:
    zf.writestr("project.qgs", text)

# Step 2: Retrieve the binary content of the ZIP file
zip_data = zip_bytes_io.getvalue()

# Step 3: Convert binary ZIP data to hexadecimal string
hex_encoded_zip = binascii.hexlify(zip_data).decode("utf-8")

# Display hex string (you can also return it, print just part, etc.)
print(hex_encoded_zip)